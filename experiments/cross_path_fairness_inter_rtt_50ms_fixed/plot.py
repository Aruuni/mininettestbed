...
def plot_run(*args):
    ...
    path = f"{HOME_DIR}/cctestbed/ns3/cross_path_fairness_inter_rtt_50mx_fixed/{aqm}/{topology}_{bw}mbit_{delay}ms_{int(qsize_in_bytes/1500)}pkts_{loss}loss_{n_flows}flows_{tcp_buffer_mult}tcpbuf_{protocol}/run{run}" 
